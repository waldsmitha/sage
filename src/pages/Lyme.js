...
const Lyme = () => {
  return (
    ...
    >
      <h1>Lyme Disease</h1>
      <p>
        Lyme Disease is endemic in our area. As someone who has experienced Lyme
        Disease first hand, As a Lyme Literate Doctor with extensive training in
        tick-borne illness, I am committed to helping those who have been
        affected, reclaim their health. Please read and share the following
        information to help prevent the occurrence of tick-borne illness.
      </p>
      <h1>Tick Removal</h1>
      <ul>
        <li>
          Remove the tick with tweezers or a tick scoop in 1 quick motion. Pull
      ...
      <ul>
        <li>
          Testing the tick will let you know if you have been exposed to Lyme or
          other tick-borne disease. This information allows for proper treatment
          from the beginning.
        </li>
        <li>
          After you have removed the tick, place the tick in a sealable plastic
          baggie and send it to TickReport.com
        </li>
      </ul>
      <h1>Treatment</h1>
      <p>
